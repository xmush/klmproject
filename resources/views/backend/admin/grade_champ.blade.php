        ...
        <div class="col-12">
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
                    <form action="{{route('admin.store_grade')}}" method="post">
                        @csrf
                                    ...
                                    <div class="col-sm-8 col-xs-12">
                                        <select class="form-control ukuran_id" id="ukuran_id" name="ukuran_id" required>
                                            ...
                                            @foreach ($data_cat as $cat)
                                                <option value="{{$cat->grade}}" data-id="{{$cat->id}}">{{$cat->grade}}</option>                                                
                                            @endforeach
                                        </select>
...
@section('pagejs')
    ...
    $(document).ready(function(){
        ...
        $.getFish = function getFish() {
            var grade = $('#ukuran_id').val();
            var url_path = $('#url_path').val();

            var r_url = url_path+'/'+grade;
